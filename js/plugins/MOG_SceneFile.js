...
Window_FileData.prototype.drawData = function () {
	...
	var w1 = this.width - 360 + x;;
	this._actorID = actor[10];
	this.changeTextColor(this.textColor(Moghunter.scFile_TextColor));
	this.drawText(String(Moghunter.scFile_PlayTimeWord), x-20, 160, 120, 'left');
	...
	if (this._gold) { this.drawText(TextManager.currencyUnit, x, 220, 120, 'left') }; // Gold
	this.resetTextColor();
	this.drawText(this.data().playtime, w1 - 40, 160, 120, 'right');
	...
	if (this._gold) { this.drawText(this.data().gold, w1 - 40, 220, 120, 'right') }; // Gold
};
